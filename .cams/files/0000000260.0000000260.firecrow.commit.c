...
char *hex_from_id(int id){
  ...
  if(fexists(hex_path)){
    ...
    struct timespec t;
    timespec_get(&t, TIME_UTC);
    hex = dk_fmtmem("%010d.%010d.%s", t.tv_nsec, t.tv_sec, commit->name);
    */
  }else{
